...
type Props = {
  data: HrFormData;
  onChange: React.Dispatch<React.SetStateAction<HrFormData>>;
};

/* ---------- COMPONENT ---------- */
export default function HrForm({ data, onChange }: Props) {
  ...
  return (
    <>
      ...
      <FormInput
        ...
        keyboardType="numeric"
        onChangeText={(v) => onChange({ ...data, experience: v })}
      />
      ...
      <FormInput
        ...
        onChangeText={(v) => onChange({ ...data, qualification: v })}
      />
      ...
      <FormInput
        ...
        onChangeText={(v) => onChange({ ...data, subject: v })}
      />
      ...
      <FormInput
        ...
        onChangeText={(v) => onChange({ ...data, university: v })}
      />
      ...
      <FormInput
        ...
        keyboardType="numeric"
        onChangeText={(v) => onChange({ ...data, percentage: v })}
      />
